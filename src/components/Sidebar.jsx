            ...
            <div className="p-3 rounded-xl bg-slate-900/40 border border-white/5">
              ...
              <div className="flex gap-2 p-1 bg-black/20 rounded-lg">
                ...
                <button 
                  ...
                  className={`flex-1 py-1.5 text-[10px] font-bold rounded-md transition-all ${customizer.backgroundType === 'image' ? 'bg-primary text-white shadow-lg' : 'text-slate-500 hover:text-slate-300'}`}
                >
                  PICTURE
                </button>
              </div>
              ...
              {customizer.backgroundType === 'color' && (
                <div className="mt-4 pt-4 border-t border-white/5 space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] text-slate-500 font-bold uppercase">Gradient End</span>
                    <input 
                      type="color" 
