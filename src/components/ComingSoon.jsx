...
const ComingSoon = ({ title }) => {
  return (
    <div className="flex-1 flex flex-col items-center justify-center bg-white/80 dark:bg-background-dark/80 p-8 text-center">
      ...
      <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tighter mb-2 uppercase">{title}</h2>
