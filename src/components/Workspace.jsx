...
const Workspace = ({ poolData, customizer }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div id="social-card-export" className="relative w-[1000px] h-[525px] flex-shrink-0 social-card-preview rounded-none shadow-[0_30px_90px_-15px_rgba(0,0,0,0.6)] border border-white/10 overflow-hidden">
