...
async function testGoApiDas(userAddress) {
  const url = 'https://go-api.accessprotocol.co/das-rpc';
  console.log(`Testing Go-API DAS at: ${url}`);
...
testGoApiDas('HLSxLAsaJWqttv1ZQaBzC3ZEjSbJva2qzc6JbREJpkn6');
