        ...
        <div className="relative z-10 w-full h-full flex flex-col p-10 justify-between text-left">
          <div className="flex flex-col justify-center flex-1">
            <div className="mb-4">
              ...
              <h1 className="text-5xl font-black text-white tracking-tighter leading-none soft-text-shadow" style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}>{displayData.creatorName}</h1>
            </div>
            
            <div className="mb-6">
              <p className="text-white/40 text-[14px] font-black uppercase tracking-[0.2em] mb-2">Total ACS Locked</p>
              <h2 className="text-6xl font-black text-white tracking-tighter leading-none drop-shadow-2xl soft-text-shadow" style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}>
            ...
            <div className="flex gap-20">
              <div className="flex flex-col">
                ...
                <p className="text-4xl font-black text-white leading-none soft-text-shadow" style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}>{displayData.stakers.toLocaleString()}</p>
              </div>
              <div className="flex flex-col">
                <p className="text-white/40 text-[13px] font-black uppercase tracking-widest mb-1.5">Global Rank</p>
                <p className="text-4xl font-black text-white leading-none soft-text-shadow" style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}>#{displayData.rank}</p>
              </div>
            </div>
          </div>
