    ...
    <div className="relative z-10 w-full h-full flex flex-col p-10 justify-between text-left">
      <div className="flex flex-col justify-center flex-1">
        {isStakerMode ? (
          <>
            <div className="mb-4">
              <p className="text-primary text-[14px] font-black uppercase tracking-[0.3em] mb-3">Subscriber Profile</p>
            ...
            <div className="flex gap-20">
              ...
              <div className="flex flex-col">
                <p className="text-white/40 text-[13px] font-black uppercase tracking-widest mb-1.5">Status</p>
                <div className="flex items-center gap-2">
                  <span className="material-symbols-outlined text-primary text-3xl">verified</span>
                  <p className="text-4xl font-black text-white leading-none tracking-tight soft-text-shadow uppercase">Verifer</p>
                </div>
              </div>
            </div>
          </>
          ...
          <div className="flex gap-6 items-center flex-row-reverse text-right">
            ...
            <div className="flex flex-col items-end justify-center mb-0.5">
              <p className="text-white/40 text-[8px] font-bold uppercase tracking-widest mb-1.5">
                {isStakerMode ? 'Verified Subscription' : 'Stake & Subscribe'}
              </p>
